...
<style>
    :root {
        ...
        .profile-card {
        background: linear-gradient(135deg, rgba(110, 15, 25, 0.95) 0%, #4a0a11 100%);
        border-radius: 24px;
        ...
        <div class="col-lg-4">
            <div class="profile-card mb-4">
                ...
                <div class="profile-avatar-container">
                    <img src="https://ui-avatars.com/api/?name=<?= urlencode($user['nama_lengkap'] ?? 'Admin Pengabdian') ?>&background=6e0f19&color=fff&size=128" class="profile-avatar">
                </div>
                ...
                <form action="<?= base_url('pelatihan/admin_pengabdian/profil/update') ?>" method="POST" class="needs-validation" novalidate>
                    ...
                    <div class="row g-4 mb-5">
                        <div class="col-md-12">
                            ...
                            <div class="form-text text-white" style="font-size: 0.75rem;">Min. 8 karakter, kombinasi angka & huruf.</div>
                        </div>
                    </div>
